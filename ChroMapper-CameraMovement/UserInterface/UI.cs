...
namespace ChroMapper_CameraMovement.UserInterface
{
    class UI
    {
        ...
        public void AddMenu(MapEditorUI mapEditorUI)
        {
            ...
            AttachTransform(_cameraMovementMenu, 170, 200, 1, 1, -50, -30, 1, 1);
            ...
            AddCheckbox(_cameraMovementMenu.transform, "Turn To Head", "Turn To Head", new Vector2(0, -55), Options.Modifier.TurnToHead, (check) =>
            {
                Options.Modifier.TurnToHead = check;
            });
            AddTextInput(_cameraMovementMenu.transform, "Head Hight", "Head Hight", new Vector2(0, -70), Options.Modifier.AvatarHeadHight.ToString(), (value) =>
            {
                float res;
            ...
            AddTextInput(_cameraMovementMenu.transform, "Head Size", "Head Size", new Vector2(0, -90), Options.Modifier.AvatarHeadSize.ToString(), (value) =>
            {
                float res;
                if (float.TryParse(value, System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture.NumberFormat, out res))
                {
            ...
            AddTextInput(_cameraMovementMenu.transform, "Script File", "Script File", new Vector2(0, -110), Options.Modifier.ScriptFileName, (value) =>
            {
                Options.Modifier.ScriptFileName = value.Trim();
            });
            AddButton(_cameraMovementMenu.transform, "Setting Reload", "Setting Reload", new Vector2(0, -140), () =>
            {
                _plugin.Reload();
            });
            AddButton(_cameraMovementMenu.transform, "Script Mapper Run", "Script Mapper Run", new Vector2(0, -170), () =>
            {
